...
DayGrid.mixin({
    ...
    fgSegHtml: function(seg, disableResizing) {
        ...
        classes.push(eventDef.className);
        var titleContent = (htmlEscape(eventDef.title || '') || '&nbsp;');
        ...
        return '<a class="' + classes.join(' ') + '"' +
                ...
                (skinCss ?
                    ...
                    "data-elt='" + JSON.stringify(eventDef.data) + "'" +
            '>' +
...
var EventDef = FC.EventDef = Class.extend(ParsableModelMixin, {
    ...
    clone: function() {
        ...
        copy.data = this.data; // should clone?
    ...
    toLegacy: function() {
        ...
        obj.data = this.data; // should clone?
    ...
    applyManualRawProps: function(rawProps) {
        ...
        // HACK add data in element
        this.data = rawProps.data;
